...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await dispatch(registerUser(formData)).unwrap(); // Dispatch registerUser action
      toast.success("Registration successful! Please login.", { position: "top-center", autoClose: 5000 });
      ...
      toast.error(err.message || "Registration failed!", { position: "top-center", autoClose: 5000 });
    }
  };
